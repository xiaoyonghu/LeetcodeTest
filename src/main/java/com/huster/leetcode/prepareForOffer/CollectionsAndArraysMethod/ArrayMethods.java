...
public class ArrayMethods {
    ...
    public void sort() {
         ...
         * 按照数字顺序排列指定的数组(并行的)。同sort方法一样也有按范围的排序
         */
        ...
        //面试有用list
        String[] sList = {"abcdehg", "abcdefg", "abcdeag"};
        Arrays.sort(sList);
        System.out.println(Arrays.toString(sList));//[abcdeag, abcdefg, abcdehg]
    ...
    public void binarySearch() {
        ...
        // 排序后再进行二分查找，二分查找的条件是字符串必须的是排序好了的
        Arrays.sort(e);
